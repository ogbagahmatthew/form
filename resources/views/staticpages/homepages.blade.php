			...
			<div class="container-fluid">
				<div class="row">
					...
					<div class="accounts col-lg-6">
						<li class="top_li"><span class="fa fa-mobile"></span><a href="tel:+234 8084382944">+234
								8084382944</a>
						</li>

						<li class="top_li"><span class="fa fa-envelope-o"></span><a href="mailto:info@oya.com">Need help? Contact us via email</a>

						</li>
						<li class="top_li1"><span class="fa fa-map-marker"></span> 12, Kukoyi Street, Lagos </li>
					</div>
				</div>
			</div>
		</div>
		...
		<nav class="navbar navbar-expand-lg navbar-light">
			<div class="container-fluid">
				...
				<a class="navbar-brand" href="#index.html">
					<img src="images/mimalo.png" alt="Your logo" title="Your logo" style="height:35px;" />
				</a> 
			...
			<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					<div class="carousel-item active">
						<div class="container">
							<div class="carousel-caption">
									...
									<h3>CLEAN <span class="b-ck">WATER IS LIFE </span></h3>
									<p>safe guard the health of your family</p>
					...
					<div class="carousel-item item2">
						<div class="container">
							<div class="carousel-caption">
								<h3>Mima 74 Water Cleanser<span class="b-ck"> Kills </span></h3>
								<p>Germs, Bacteria, Virus and Makes Water safe for Drinking</p>
								<a href="Mima" class="banner-btn btn">Read More</a>
							</div>
						</div>
					</div>
			 ...
			 <div class="container py-lg-5">
					 <div class="content-info-in row">
							 <div class="content-gd col-lg-4">
									 <h3 class="hny-title">
										We exist to make you happy <span class="dot-1">.</span></h3>
							 </div>
							 <div class="content-gd col-lg-4">
									 <p>We are in business to give you the best of services and to make you happy always.</p>
							 </div>
							 <div class="content-gd col-lg-4">
									 <p>We have conquered conquered territories with our wealth of marketing experience thereby giving you quality services you cannot get anywhere else.</p> 
							 </div>
			 ...
			 <div class="container-fluid">
					<div class="align-counter-6-inf-cols row">
						<div class="counter-6-inf-left col-lg-6">
							<h3 class="hny-title two">Leading the way in the Real Estate Business<span class="dot-1">.</span></h3>
						...
						<div class="counter-6-inf-right col-lg-6">
								<div class="specification">
										...
										<div class="specification-info">	
											...
											<p>We have new and conteporary designs that will surprise you. Our engineers are award winning in their field of specialty.</p>
										</div>
								...
								<div class="specification">
										...
										<div class="specification-info">	
											<h6><a href="#">Renting</a></h6>
											<p>With just a click you are closer to getting a property of your choice anywhere in Nigeria.</p>
										</div>
								...
								<div class="specification">
										...
										<div class="specification-info">	
											...
											<p>We will support you with our wealth of experience in the real Estate sector.</p>
										</div>
								...
								<div class="specification last-one">
										...
										<div class="specification-info">	
											<h6><a href="#">Buying or Selling</a></h6>
											<p>Buy or sell withing a record time. You are likely to get the best deal on our site where you cannot get anywhere else.</p>
										</div>
			...
			<ul class="portfolio-area clearfix p-0 m-0 row">
				<li class="portfolio-item2 content" data-id="id-1" data-type="cat-item-1">
					<span class="image-block">
						...
						<a class="image-zoom" href="images/p1.jpg" data-gal="prettyPhoto[gallery]">
							<div class="content-overlay"></div>
							<img src="images/p1.jpg" class="img-fluid" alt="portfolio-img">
				...
				<li class="portfolio-item2 content" data-id="id-2" data-type="cat-item-2">
					<span class="image-block">
						...
						<a class="image-zoom" href="images/p2.jpg" data-gal="prettyPhoto[gallery]">
							<div class="content-overlay"></div>
							<img src="images/p2.jpg" class="img-fluid" alt="portfolio-img">
							<div class="content-details fadeIn-bottom">
								<h3 class="content-title">Add Your Title</h3>
				...
				<li class="portfolio-item2 content" data-id="id-3" data-type="cat-item-1">
					<span class="image-block">
						...
						<a class="image-zoom" href="images/p3.jpg" data-gal="prettyPhoto[gallery]">
							<div class="content-overlay"></div>
							<img src="images/p3.jpg" class="img-fluid" alt="portfolio-img">
							<div class="content-details fadeIn-bottom">
								<h3 class="content-title">Add Your Title</h3>
				...
				<li class="portfolio-item2 content" data-id="id-7" data-type="cat-item-3">
					<span class="image-block">
						...
						<a class="image-zoom" href="images/p4.jpg" data-gal="prettyPhoto[gallery]">
							<div class="content-overlay"></div>
							<img src="images/p4.jpg" class="img-fluid" alt="portfolio-img">
							<div class="content-details fadeIn-bottom">
								<h3 class="content-title">Add Your Title</h3>
				...
				<li class="portfolio-item2 content" data-id="id-2" data-type="cat-item-2">
						<span class="image-block">
							<a class="image-zoom" href="images/p5.jpg" data-gal="prettyPhoto[gallery]">
								<div class="content-overlay"></div>
								<img src="images/p5.jpg" class="img-fluid" alt="portfolio-img">
								<div class="content-details fadeIn-bottom">
									<h3 class="content-title">Add Your Title</h3>
				...
				<li class="portfolio-item2 content" data-id="id-7" data-type="cat-item-3">
					<span class="image-block">
						...
						<a class="image-zoom" href="images/p6.jpg" data-gal="prettyPhoto[gallery]">
							<div class="content-overlay"></div>
							<img src="images/p6.jpg" class="img-fluid" alt="portfolio-img">
							<div class="content-details fadeIn-bottom">
								<h3 class="content-title">Add Your Title</h3>
