...
<head>
	...
	<title>Handler a Corporate Category Bootstrap Responsive Website Template | Services :: W3layouts</title>
	<!-- Template CSS -->
	...
	<section class="w3l-top-header-content">
		<div class="hny-top-menu">
				...
				<div class="container-fluid">
					<div class="row">
						...
						<div class="accounts col-lg-6">
							...
							<li class="top_li"><span class="fa fa-envelope-o"></span><a
									href="mailto:info@example.com">Need help? Contact us via email</a>
			...
			<nav class="navbar navbar-expand-lg navbar-light">
				<div class="container-fluid">
					<a class="navbar-brand" href="index.html"><span class="fa fa-podcast" aria-hidden="true"></span>
						<label class="lohny">H</label>andler</a>
