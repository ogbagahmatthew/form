...
<head>
  ...
  <title>Handler a Corporate Category Bootstrap Responsive Website Template | About Us :: W3layouts</title>
  <!-- Template CSS -->
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto">
						<li class="nav-item">
							<a class="nav-link" href="homepages">Home</a>
						</li>
        ...
        <div class="container">
          <nav aria-label="breadcrumb">
            ...
            <ol class="breadcrumb mb-0">
              <li class="breadcrumb-item"><a href="homepages">Home</a></li>
			 ...
			 <div class="container py-lg-5">
					<div class="welcome-grids row">
							<div class="col-lg-6 mb-lg-0 mb-5">
								<h3 class="hny-title">MIMA 74 WATER CLEANSER..!
									 <br>Welcome to Handler<span class="dot-1">.</span></h3>
								<p class="my-4">Clean and healthy water is a major challenge for many families but with us, every water is clean...</p>
								<div class="read">
									<a href="aboutus" class="read-more-btn btn">Read More</a>
								</div>	
							</div>
							<div class="col-lg-3 col-md-4 col-6 welcome-image">
								<img src="images/mimaboy.jpg" class="img-fluid" alt="" />
							</div>	
							<div class="col-lg-3 col-md-4 col-6 welcome-image">
									<img src="images/mimabo.jpg" class="img-fluid" alt="" />
							</div>
						</div>	
					...
					<div class="align-counter-6-inf-cols row">
						...
						<div class="counter-6-inf-right counter-6-inf-right2 col-lg-6">
								...
								<div class="calltoaction-text-info mt-lg-5 mt-4">
									...
									<div class="buttons">
											<a href="blog-single.html" class="read-more-btn btn">Read More</a>
											<a href="blog-single.html" class="read-more-btn2 btn">More Info</a>
										</div>
						</div>
					</div>
				 </div>
